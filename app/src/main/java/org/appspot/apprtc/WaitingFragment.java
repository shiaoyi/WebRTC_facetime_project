...
//        boolean onToggleMic();
    ...
    public View onCreateView(
        ...
        controlView = inflater.inflate(R.layout.fragment_waiting, container, false);
...
//                    new CaptureQualityController(captureFormatText, (CallFragment.OnCallEvents) callEvents));
//        } else {
